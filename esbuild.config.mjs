...
const ctx = await esbuild.context({
  ...
  metafile: profile.name === "community",
  banner: { js: banner },
  plugins: [...profile.plugins, neutralise],
  minify: false,
...
if (prod) {
  ...
  if (profile.name === "community") {
    for (const name of ["manifest.json", "styles.css"]) fs.copyFileSync(name, path.join(profile.outputDir, name));
